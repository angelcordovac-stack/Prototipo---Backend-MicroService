package dsw.ms.identidad.security;
...
/**
 * Filtro JWT de Identidad: valida el token y ademas consulta la BD de usuarios
 * para rechazar cuentas desactivadas aunque tengan un JWT valido.
 */
@Component
