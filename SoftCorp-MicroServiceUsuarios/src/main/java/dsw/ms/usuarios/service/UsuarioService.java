...
public class UsuarioService {
    ...
    /**
     * DTO publico minimo, usado por otros microservicios (ej. ms-diccionario-fallas)
     * para resolver el nombre de un autor sin exponer la entidad completa.
     */
    ...
    /**
     * Si el usuario es Tecnico (idPerfil == 2), garantiza que exista un registro
     * en la tabla "tecnicos". Si dejo de serlo, elimina ese registro.
     */
